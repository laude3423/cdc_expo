...
if($groupeID===2){
    ...
    $query = "SELECT att.* FROM attestation AS att INNER JOIN users AS u ON att.id_user = u.id_user 
    LEFT JOIN direction AS di ON di.id_direction = u.id_direction WHERE di.id_direction = $id_direction";
}
...
//renommer
$prefix_name = "Liste_attestation_". $nom_direction . "_export_";
