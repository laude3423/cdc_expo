...
if(count($id_sub)> 0){
        //PF brute
        $queryR = "SELECT dcc.id_data_cc, ts.nom_type_substance, csub.nom_couleur_substance, s.nom_substance, cfac.poids_facture, cfac.unite_poids_facture FROM data_cc dcc 
        INNER JOIN contenu_facture cfac ON dcc.id_data_cc = cfac.id_data_cc
        ...
        WHERE ts.code_type_substance = 'PF' AND c.id_categorie =1 AND dcc.id_data_cc=$id_data";
        ...
        if(mysqli_num_rows($result)> 0){
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                if($row['unite_poids_facture']=='g'){
                    ...
                    $unite_kg ="KILOGRAMMES"; $unite_kg2 = "kgs";
        ...
        LEFT JOIN categorie c ON c.id_categorie = sds.id_categorie
        LEFT JOIN couleur_substance csub ON csub.id_couleur_substance = sds.id_couleur_substance
        WHERE ts.code_type_substance = 'PF' AND c.id_categorie =2 AND dcc.id_data_cc=$id_data";
        ...
        if(mysqli_num_rows($result1)> 0){
            ...
            if($sommePoids_kg_pft != 0){
                $afficheWord_pft[] = generateAfficheWord($nom_type_kg,$categorie, $nom_substance_kg,$sommePoids_kg_pft,$unite_kg,$unite_kg2, $couleur_substance_pfb);
            }
            if($sommePoids != 0){
        ...
        LEFT JOIN categorie c ON c.id_categorie = sds.id_categorie
        LEFT JOIN couleur_substance csub ON csub.id_couleur_substance = sds.id_couleur_substance
        WHERE ts.code_type_substance = 'PP' AND c.id_categorie =1 AND dcc.id_data_cc=$id_data";
        ...
        LEFT JOIN categorie c ON c.id_categorie = sds.id_categorie
        LEFT JOIN couleur_substance csub ON csub.id_couleur_substance = sds.id_couleur_substance
        WHERE ts.code_type_substance = 'PP' AND c.id_categorie =2 AND dcc.id_data_cc=$id_data";
