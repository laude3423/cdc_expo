...
$query='';
if($groupeID===2){
    $query = "SELECT dcc.num_facture, dcc.date_facture, contenu.poids_facture, contenu.prix_unitaire_facture, prix_unitaire_facture * poids_facture AS prix_total,
    gr.nom_granulo, sub.nom_substance,cou.nom_couleur_substance, typeSub.nom_type_substance, tr.nom_transparence, dg.nom_degre_couleur, 
    ...
    cate.nom_categorie, di.nom_durete, dim.nom_dimension_diametre, f.nom_forme_substance
        ...
        LEFT JOIN direction AS dir ON dir.id_direction= us.id_direction
        LEFT JOIN durete AS di ON di.id_durete=sds.id_durete
        WHERE dir.id_direction=$id_direction GROUP BY dcc.id_data_cc";
}
...
//renommer
$prefix_name = "Liste_facture_". $nom_direction . "_export_";
