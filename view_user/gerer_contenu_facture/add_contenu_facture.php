                ...
                <input type="hidden" class="form-control" id="id_data_cc" name="id_data_cc" required>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="id_couleur_substance" name="id_couleur_substance" required>
                                <option value="">Sélectionner...</option>
                                <!-- Remplir les options en récuprant les types de substance depuis la base de donnes -->
                                <?php
                                // Connexion à la base de donnes
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="poids_facture" name="poids_facture" step="0.01" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="unite_poids_facture" class="fw-bold">Unité :</label>
                            <select class="form-select" id="unite_poids_facture" name="unite_poids_facture" required>
                                <option value="">Sélectionner...</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="prix_unitaire_facture" name="prix_unitaire_facture" step="0.01" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="id_dimension_diametre" name="id_dimension_diametre" required>
                                <option value="">Sélectionner...</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="id_lp1_info" name="id_lp1_info" autocomplete="off" required>
                            <option value="">Sélectionner...</option>
                            <!-- Remplir les options en récuprant les types de substance depuis la base de donnes -->
                            <?php
                            // Connexion à la base de donnes
