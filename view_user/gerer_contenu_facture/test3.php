    ...
    <div class="info  container">
        ...
        <div class="info1">
            <div class="alert alert-light" role="alert">
                ...
                <?php }else{ ?>
                <p><strong>Scan LP1:</strong> <a
                        href="https://cdc.minesmada.org/<?php echo htmlspecialchars($row['scan_lp1'], ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars($row['numero_lp1'], ENT_QUOTES, 'UTF-8'); ?>.pdf</a>
                </p>
            ...
            <div class="alert alert-light" role="alert">
                <?php
                        ...
                        <div id="pdf-container">
                            <a href="https://lp1.minesmada.org/<?php echo $lien_corrige; ?>">
                        ...
                        const pdfUrl = "<?php echo 'https://lp1.minesmada.org/'.$lien_corrige; ?>";
