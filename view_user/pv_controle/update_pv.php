...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if($num_pv){
          ...
          `lien_pv_controle`='$pathToSave',`pj_pv_controle`='$pathToSavePDF',`date_modification_pv_controle`='$dateInsert',`premiere_validation_cdc`='En attente',`deuxieme_validation_cdc`='En attente',`validation_controle`='En attente',
