...
<div class="containr">
    ...
    <div
        class="custom-bg d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
        ...
        <ul class="nav d-none d-md-flex col-md-auto mb-2 justify-content-center mb-md-0">
            ...
            <?php if($groupeID === 1) {?>
            <li class="nav-item"><a href="https://cdc.minesmada.org/home/home.php" class="nav-link text-white">Home</a>
            </li>
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item text-white text-white"
                            href="https://cdc.minesmada.org/view/societe_expediteur/lister.php">Société
        ...
        <li class="nav-item"><a href="https://cdc.minesmada.org/view_user/ancien_lp/lister.php"
                class="nav-link text-white">Ancien_lp<?php afficherBadgeNonValid($conn, 'ancien_lp', 'validation_lp', $code_fonction); ?></a>
        <li><a href="https://cdc.minesmada.org/view_user/pv_controle/lister.php"
                class="nav-link px-2 text-white">Contrôle
        ...
        <div class="col-md-3">
            <div id="profileDropdown">
                <?php
                    ...
                    if (empty($image_url)) {
                        $full_image_url = 'https://cdc.minesmada.org/logo/person-circle.png';
                    }
                    ?>
                ...
                <ul id="profileMenu">
                    <li><a href="https://cdc.minesmada.org/view/gerer_utilisateur/compte.php"
                            class="dropdown-item text-white">Profile</a>
                    </li>
                    <li><a href="https://cdc.minesmada.org/home/condition_utilisation.php"
                            class="dropdown-item text-white">Condition</a>
                    </li>
                    <li>
                        <hr>
                    </li>
