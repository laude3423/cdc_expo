          ...
          <div class="wrap login-wrapper mx-auto">
            ...
            <form class="login-form" method="POST" action="">
                <div class="form-group mb-4">
                    <input id="inputEmail" type="email" name="adresse_email" placeholder="Email address" required="" autofocus="" class="form-control rounded-pill border-0 shadow-sm px-4">
                </div>
                <div class="form-group mb-4">
                    <input id="inputPassword" name="mots_de_passe" type="password" placeholder="Password" required="" class="form-control rounded-pill border-0 shadow-sm px-4 text-primary">
                </div>
                <!-- <div class="custom-control custom-checkbox mb-3">
                    <input id="customCheck1" type="checkbox" checked class="custom-control-input">
                    <label for="customCheck1" class="custom-control-label">Remember password</label>
                </div> -->
                <button type="submit"class="btn btn-dark btn-block text-uppercase mb-2 rounded-pill shadow-sm">Se connecter</button>
            </form>          
            <p class="login-wrapper-footer-text">Besoin d'un compte ? <a href="scripts/inscription.php" class="text-reset"> S'inscrire </a></p>
          </div>
        </div>
      </div>
    </div>
