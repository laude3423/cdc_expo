...
$sql="SELECT * FROM users WHERE id_user=$userID";
    ...
    $politique = $row['status_politique'] ?? 0;
    $condition =$row['status_condition'] ?? 0;
    ...
    <div class="container">
        <div class="container rounded-border custom-text-justify">
            <div class="alert" role="alert">
                ...
                <p class="text-justify">En utilisant l'Application, vous déclarez avoir lu, compris et accepté les
                    présentes
                    Conditions. Si vous utilisez l'Application au nom de votre Direction Régionale, Direction
                    Interrégionale
                ...
                <p class="text-justify">Vous êtes autorisé à utiliser l'Application pour générer le "PV de scellage, le
                    PV
                    de
                    contrôle et constantation et le certificat de foncformité"
                    munis d'un code QR conformément aux normes éthiques. Vous vous engagez à ne pas utiliser
                    l'Application à
                ...
                <p>Lors de votre inscription, vous devrez créer un mot de passe pour utiliser cette présente
                    application.
                    ...
                    Vous devez nous informer immédiatement si vous soupçonnez une utilisation ou un accès non autorisé
                    de
                    votre compte. Nous ne saurions être tenus responsables de toute perte ou de tout préjudice subi
                    parce
                    que vous n’avez pas gardé votre mot de passe secret, si vous laissez quelqu’un d’autre utiliser
                    votre
                    compte, ou si vous constatez ou soupçonnez une utilisation non autorisée de votre compte sans nous
                    avoir
                ...
                <p class="text-justify">Nous pouvons résilier votre accès à l'Application à tout moment en cas de
                    violation
                    de ces Conditions ou pour toute autre raison. En cas de résiliation, vous devez cesser toute
                    utilisation
                    de l'Application.</p>
                <li><strong>Contact</strong></li>
                <p class="text-justify">Pour toute question ou préoccupation concernant ces Conditions, veuillez
                    contacter
                    le DGM.</p>
            ...
            <form method="post" action="" class="needs-validation">
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="same-acceptation_condition">"J'accepte les conditions
                        d'utilisation
                        de l'application"</label>
                </div>
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="acceptation_politique"
                        name="acceptation_politique" required>
                    <label class="form-check-label" for="same-acceptation_politique">"J'accepte les <a
                            href="politique.php" class="href">politiques de confidentialité</a>."</label>
                </div>
                <hr class="my-4">
