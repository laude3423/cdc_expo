...
$edit_societe_id = isset($_GET['edit_id']) ? $_GET['edit_id'] : null;
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($id_agent)) {
            ...
            $stmt = $conn->prepare("INSERT INTO `agent_controle`( `nom_agent`, `prenom_agent`, `matricule`) VALUES (?, ?, ?)");
            $stmt->bind_param("ssss", $nom, $prenom, $matricule);
            if ($stmt->execute()) {
            ...
            $sql = "UPDATE `agent_controle` SET `nom_agent`='$nom',`prenom_agent`='$prenom',`matricule`='$matricule' WHERE id_agent_controle='$id_agent'";
...
<body>
    <div class="container">
        ...
        <table id="agentTable" class="table table-hover text-center">
            ...
            <tbody>
                <?php 
                $sql="SELECT * FROM `agent_controle`";
                $result= mysqli_query($conn, $sql);
                ...
                <tr>
                    ...
                    <td>
                        <a href="#" class="link-dark" onclick="openModal(<?php echo $row['id_agent_controle']?>)"><i
                                class="fa-solid fa-pen-to-square me-3"></i></a>
                        <a href="#" class="link-dark"
                            onclick="confirmerSuppression(<?php echo $row['id_agent_controle']?>)"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Nouveau agent de controle</h1>
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        <div class="mb-3">
                            <label for="matricule" name="matricule" class="col-form-label">Matricule:</label>
                            <input type="text" class="form-control" name="matricule" id="matricule"
                                placeholder="Matricule de l'agent" required style="font-size:90%">
                        </div>
                        <div class="mb-3">
    ...
    function confirmerSuppression(id) {
        // Utilisation de la matricule confirm pour afficher une boîte de dialogue
