...
$edit_societe_id = isset($_GET['edit_id']) ? $_GET['edit_id'] : null;
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($id_continent)) {
            ...
            $sql = "INSERT INTO `continent`(`nom_continent`) VALUES ('$nom')";
            ...
            $sql = "UPDATE `continent` SET `nom_continent`='$nom' WHERE id_continent='$id_continent'";
            $result = mysqli_query($conn, $sql);
...
<body>
        ...
        <table id="agentTable" class="table table-hover text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="#" class="link-dark" onclick="openModal(<?php echo $row['id_continent']?>)"><i
                                class="fa-solid fa-pen-to-square me-3"></i></a>
                        <a href="#" class="link-dark"
                            onclick="confirmerSuppression(<?php echo $row['id_continent']?>)"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Nouvel continent</h1>
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        <div class="mb-3">
                            <label for="nom" name="nom" class="col-form-label">Nom du continent:</label>
                            <input type="text" class="form-control" name="nom" id="nom" placeholder="Nom du continent"
    ...
    function openModal(edit_id = null) {
        ...
        if (edit_id) {
            ...
            document.getElementById('staticBackdropLabel').innerText = 'Modifier continent';
            var id = edit_id;
            ...
            function getDataById(id) {
                $.ajax({
                    ...
                    success: function(data) {
                        $('#id').val(data.id_continent);
                        $('#nom').val(data.nom_continent);
                    },
                    error: function(xhr, status, error) {
            ...
            document.getElementById('staticBackdropLabel').innerText = 'Nouvel continent';
