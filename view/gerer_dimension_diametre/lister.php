...
$edit_societe_id = isset($_GET['edit_id']) ? $_GET['edit_id'] : null;
    ...
    if (isset($_POST['submit'])) {
        $nom = $_POST['nom'];
        $id_dimension_diametre = $_POST['id'];

        if (empty($id_dimension_diametre)) {
            // Insertion d'une nouvelle société
            $sql = "INSERT INTO `dimension_diametre`(`nom_dimension_diametre`) VALUES ('$nom')";
            ...
            $sql = "UPDATE `dimension_diametre` SET `nom_dimension_diametre`='$nom' WHERE id_dimension_diametre='$id_dimension_diametre'";
            $result = mysqli_query($conn, $sql);
...
if (!empty($edit_societe_id)) {
    $sql_edit = "SELECT * FROM `dimension_diametre` WHERE `id_dimension_diametre`='$edit_societe_id'";
...
<body>
    <div class="container">
        <div class="row mb-3" style="margin-top: 30px;">
            <div class="col md-8 mb-3">
                <h5>Liste des dimensions ou diamètres de substance</h5>
            </div>
        ...
        <table class="table table-hover text-center">
            <thead class="table-dark">
                <tr>
                    <th scope="col">Dimension ou diamètre</th>
                    <th scope="col">Actions</th>
                </tr>
            </thead>
            <tbody>
                <?php 
                $sql="SELECT * FROM `dimension_diametre`";
                $result= mysqli_query($conn, $sql);
                ...
                <tr>
                    ...
                    <td>
                        <a href="#" class="link-dark" onclick="openModal(<?php echo $row['id_dimension_diametre']?>)"><i
                                class="fa-solid fa-pen-to-square me-3"></i></a>
                        <a href="#" class="link-dark"
                            onclick="confirmerSuppression(<?php echo $row['id_dimension_diametre']?>)"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Nouvelle dimension ou diamètre</h1>
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        <div class="mb-3">
                            <label for="nom" name="nom" class="col-form-label">Dimension ou diamètre:</label>
                            <input type="text" class="form-control" name="nom" id="nom"
                                placeholder="Dimension ou diamètre de la substance" required style="font-size:90%">
    ...
    function openModal(edit_id = null) {
        ...
        if (edit_id) {
            ...
            document.getElementById('staticBackdropLabel').innerText = 'Modifier dimension ou diamètre';
            var id = edit_id;
            ...
            function getDataById(id) {
                $.ajax({
                    ...
                    success: function(data) {
                        $('#id').val(data.id_dimension_diametre);
                        $('#nom').val(data.nom_dimension_diametre);
                    },
                    error: function(xhr, status, error) {
            ...
            document.getElementById('staticBackdropLabel').innerText = 'Nouvelle dimension ou diamètre';
