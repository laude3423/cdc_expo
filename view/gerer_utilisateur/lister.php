...
<head>
   ...
   <!--Bootstrap CSS-->
    ...
    <!--Bootstrap JS-->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js" integrity="sha384-rbs5jQhjAAcWNfo49T8YpCB9WAlUjRRJZ1a1JqoD9gZ/peS9z3z9tpz9Cg3i6/6S" crossorigin="anonymous"></script>
...
<body>
    <div class="container">
        <div class="row mb-3" style="margin-top: 30px;">
            ...
            <div class="col md-10 text-end">
                <a class="btn btn-dark btn-sm rounded-pill px-3 mb-3" href="#" onclick="openModal()"><i class="fa-solid fa-add me-1"></i>Ajouter nouveau</a>
            </div>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    <a href="#" class="link-dark" onclick="openModal(<?php echo $row['id_user']?>)"><i class="fa-solid fa-pen-to-square me-3"></i></a>
                     <a href="#" class="link-dark" onclick="confirmerSuppression(<?php echo $row['id_user']?>)"><i class="fa-solid fa-trash "></i></a>
                    </td>
                </tr>   
                <?php   
                }
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="staticBackdropLabel" style="font-size:90%; font-weight:bold">
      ...
      <div class="modal-body">
        <form  id="societeForm" action="" method="post">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="nom"  id="nom" placeholder="Nom complète" required style="font-size:90%">
          </div>
          <div class="mb-3">
            <label for="prenom" name="prenom" class="col-form-label">prenom de la société:</label>
            <input type="text" class="form-control" id="prenom" name="prenom" placeholder="prenom complète" required style="font-size:90%">
          </div>
          <div class="mb-3">
            <label for="password" name="password" class="col-form-label">password de la société:</label>
            <input type="number" class="form-control" id="password" name="password" placeholder="Numéro de téléphone" required style="font-size:90%" pattern="[0-9]{10}">
          </div>
          <div class="mb-3">
            <label for="email" name="email" class="col-form-label">Email de la société:</label>
            <input type="email" class="form-control" id="email" name="email" placeholder="prenom email" required style="font-size:90%">
