...
$edit_societe_id = isset($_GET['edit_id']) ? $_GET['edit_id'] : null;
    ...
    if (isset($_POST['submit'])) {
        $nom = $_POST['nom'];
        $id_forme_substance = $_POST['id'];

        if (empty($id_forme_substance)) {
            // Insertion d'une nouvelle société
            $sql = "INSERT INTO `forme_substance`(`nom_forme_substance`) VALUES ('$nom')";
            ...
            $sql = "UPDATE `forme_substance` SET `nom_forme_substance`='$nom' WHERE id_forme_substance='$id_forme_substance'";
            $result = mysqli_query($conn, $sql);
...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <h5>Liste des formes des substances</h5>
            </div>
            <div class="col">
        ...
        <table id="agentTable" class="table table-hover text-center">
            ...
            <tbody>
                <?php 
                $sql="SELECT * FROM `forme_substance`";
                $result= mysqli_query($conn, $sql);
                ...
                <tr>
                    ...
                    <td>
                        <a href="#" class="link-dark" onclick="openModal(<?php echo $row['id_forme_substance']?>)"><i
                                class="fa-solid fa-pen-to-square me-3"></i></a>
                        <a href="#" class="link-dark"
                            onclick="confirmerSuppression(<?php echo $row['id_forme_substance']?>)"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Nouvelle forme</h1>
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        <div class="mb-3">
                            <label for="nom" name="nom" class="col-form-label">Nom de la forme:</label>
                            <input type="text" class="form-control" name="nom" id="nom" placeholder="Nom de la forme"
    ...
    function openModal(edit_id = null) {
        ...
        if (edit_id) {
            ...
            document.getElementById('staticBackdropLabel').innerText = 'Modifier la forme';
            var id = edit_id;
            ...
            function getDataById(id) {
                $.ajax({
                    ...
                    success: function(data) {
                        $('#id').val(data.id_forme_substance);
                        $('#nom').val(data.nom_forme_substance);
                    },
                    error: function(xhr, status, error) {
            ...
            document.getElementById('staticBackdropLabel').innerText = 'Nouvelle forme';
