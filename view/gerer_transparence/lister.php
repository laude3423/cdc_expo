...
$edit_societe_id = isset($_GET['edit_id']) ? $_GET['edit_id'] : null;
    ...
    if (isset($_POST['submit'])) {
        $nom = $_POST['nom'];
        $id_transparence = $_POST['id'];

        if (empty($id_transparence)) {
            // Insertion d'une nouvelle société
            $sql = "INSERT INTO `transparence`(`nom_transparence`) VALUES ('$nom')";
            ...
            $sql = "UPDATE `transparence` SET `nom_transparence`='$nom' WHERE id_transparence='$id_transparence'";
            $result = mysqli_query($conn, $sql);
...
if (!empty($edit_societe_id)) {
    $sql_edit = "SELECT * FROM `transparence` WHERE `id_transparence`='$edit_societe_id'";
        ...
        <table id="agentTable" class="table table-hover text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="#" class="link-dark" onclick="openModal(<?php echo $row['id_transparence']?>)"><i
                                class="fa-solid fa-pen-to-square me-3"></i></a>
                        <a href="#" class="link-dark"
                            onclick="confirmerSuppression(<?php echo $row['id_transparence']?>)"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Nouvelle transparence</h1>
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        <div class="mb-3">
                            <label for="nom" name="nom" class="col-form-label">Nom de la transparence:</label>
            ...
            function getDataById(id) {
                $.ajax({
                    ...
                    success: function(data) {
                        $('#id').val(data.id_transparence);
                        $('#nom').val(data.nom_transparence);
                    },
                    error: function(xhr, status, error) {
