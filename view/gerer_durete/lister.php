...
$edit_societe_id = isset($_GET['edit_id']) ? $_GET['edit_id'] : null;
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($id_durete)) {
            ...
            $sql = "INSERT INTO `durete`(`nom_durete`) VALUES ('$nom')";
            ...
            $sql = "UPDATE `durete` SET `nom_durete`='$nom' WHERE id_durete='$id_durete'";
            $result = mysqli_query($conn, $sql);
...
<body>
        ...
        <table class="table table-hover text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="#" class="link-dark" onclick="openModal(<?php echo $row['id_durete']?>)"><i
                                class="fa-solid fa-pen-to-square me-3"></i></a>
                        <a href="#" class="link-dark" onclick="confirmerSuppression(<?php echo $row['id_durete']?>)"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Nouvelle dureté</h1>
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        <div class="mb-3">
                            <label for="nom" name="nom" class="col-form-label">Nom de la dureté:</label>
                            <input type="text" class="form-control" name="nom" id="nom" placeholder="Nom de la dureté"
    ...
    function openModal(edit_id = null) {
        ...
        if (edit_id) {
            ...
            document.getElementById('staticBackdropLabel').innerText = 'Modifier la dureté';
            var id = edit_id;
            ...
            function getDataById(id) {
                $.ajax({
                    ...
                    success: function(data) {
                        $('#id').val(data.id_durete);
                        $('#nom').val(data.nom_durete);
                    },
                    error: function(xhr, status, error) {
            ...
            document.getElementById('staticBackdropLabel').innerText = 'Nouvelle dureté';
