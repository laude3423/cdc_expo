...
$edit_societe_id = isset($_GET['edit_id']) ? $_GET['edit_id'] : null;
    ...
    if (isset($_POST['submit'])) {
        $nom = $_POST['nom'];
        $id_couleur_substance = $_POST['id'];

        if (empty($id_couleur_substance)) {
            // Insertion d'une nouvelle société
            $sql = "INSERT INTO `couleur_substance`(`nom_couleur_substance`) VALUES ('$nom')";
            ...
            $sql = "UPDATE `couleur_substance` SET `nom_couleur_substance`='$nom' WHERE id_couleur_substance='$id_couleur_substance'";
            $result = mysqli_query($conn, $sql);
...
if (!empty($edit_societe_id)) {
    $sql_edit = "SELECT * FROM `couleur_substance` WHERE `id_couleur_substance`='$edit_societe_id'";
...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <h5>Liste des couleurs des substances</h5>
            </div>
            <div class="col">
        ...
        <table id="agentTable" class="table table-hover text-center">
            <thead class="table-dark">
                <tr>
                    <th scope="col"></th>
                    <th scope="col">Couleur de la substance</th>
                    <th scope="col">Actions</th>
                </tr>
            </thead>
            <tbody>
                <?php 
                $sql="SELECT * FROM `couleur_substance`";
                $result= mysqli_query($conn, $sql);
                ...
                <tr>
                    ...
                    <td>
                        <a href="#" class="link-dark" onclick="openModal(<?php echo $row['id_couleur_substance']?>)"><i
                                class="fa-solid fa-pen-to-square me-3"></i></a>
                        <a href="#" class="link-dark"
                            onclick="confirmerSuppression(<?php echo $row['id_couleur_substance']?>)"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Nouvelle couleur</h1>
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        <div class="mb-3">
                            <label for="nom" name="nom" class="col-form-label">Nom de couleur de la substance:</label>
                            <input type="text" class="form-control" name="nom" id="nom"
                                placeholder="Nom de couleur de la substance" required style="font-size:90%">
    ...
    function openModal(edit_id = null) {
        ...
        if (edit_id) {
            ...
            document.getElementById('staticBackdropLabel').innerText = 'Modifier couleur';
            var id = edit_id;
            ...
            function getDataById(id) {
                $.ajax({
                    ...
                    success: function(data) {
                        $('#id').val(data.id_couleur_substance);
                        $('#nom').val(data.nom_couleur_substance);
                    },
                    error: function(xhr, status, error) {
            ...
            document.getElementById('staticBackdropLabel').innerText = 'Nouvelle couleur';
