...
$edit_societe_id = isset($_GET['edit_id']) ? $_GET['edit_id'] : null;
    ...
    if (isset($_POST['submit'])) {
        $nom = $_POST['nom'];
        $id_degre_couleur = $_POST['id'];

        if (empty($id_degre_couleur)) {
            // Insertion d'une nouvelle société
            $sql = "INSERT INTO `degre_couleur`(`nom_degre_couleur`) VALUES ('$nom')";
            ...
            $sql = "UPDATE `degre_couleur` SET `nom_degre_couleur`='$nom' WHERE id_degre_couleur='$id_degre_couleur'";
            $result = mysqli_query($conn, $sql);
...
<body>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="#" class="link-dark"
                            onclick="confirmerSuppression(<?php echo $row['id_degre_couleur']?>)"><i
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Nouveau degré de couleur</h1>
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        <div class="mb-3">
                            <label for="nom" name="nom" class="col-form-label">Nom de degré de la couleur:</label>
                            <input type="text" class="form-control" name="nom" id="nom"
                                placeholder="Nom de degré de la couleur" required style="font-size:90%">
    ...
    function openModal(edit_id = null) {
        ...
        if (edit_id) {
            ...
            document.getElementById('staticBackdropLabel').innerText = 'Modifier le degré de couleur';
            var id = edit_id;
            ...
            function getDataById(id) {
                $.ajax({
                    ...
                    success: function(data) {
                        $('#id').val(data.id_degre_couleur);
                        $('#nom').val(data.nom_degre_couleur);
                    },
                    error: function(xhr, status, error) {
            ...
            document.getElementById('staticBackdropLabel').innerText = 'Nouveau degré de couleur';
