...
$edit_societe_id = isset($_GET['edit_id']) ? $_GET['edit_id'] : null;
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($id_substance)) {
            ...
            $sql = "INSERT INTO `substance`(`nom_substance`) VALUES ('$nom')";
            ...
            $sql = "UPDATE `substance` SET `nom_substance`='$nom' WHERE id_substance='$id_substance'";
            $result = mysqli_query($conn, $sql);
...
<body>
    <div class="container">
        ...
        <table id="agentTable" class="table table-hover text-center">
            ...
            <tbody>
                <?php 
                $sql="SELECT sub.* , typesub.* FROM substance sub INNER JOIN type_substance typesub ON sub.id_type_substance= typesub.id_type_substance";
                $result= mysqli_query($conn, $sql);
                ...
                <tr>
                    ...
                    <td>
                        <a href="../gerer_detail_substance/lister.php?id=<?php echo $row['id_substance']?>"
                            class="link-dark me-3"><i class="fas fa-info-circle"></i>détails</a>
