...
$edit_societe_id = isset($_GET['edit_id']) ? $_GET['edit_id'] : null;
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($id_categorie)) {
            ...
            $sql = "UPDATE `categorie` SET `nom_categorie`='$nom' WHERE id_categorie='$id_categorie'";
            $result = mysqli_query($conn, $sql);
...
<body>
        ...
        <table id="agentTable" class="table table-hover text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="#" class="link-dark" onclick="openModal(<?php echo $row['id_categorie']?>)"><i
                                class="fa-solid fa-pen-to-square me-3"></i></a>
                        <a href="#" class="link-dark"
                            onclick="confirmerSuppression(<?php echo $row['id_categorie']?>)"><i
    ...
    function openModal(edit_id = null) {
        ...
        if (edit_id) {
            ...
            document.getElementById('staticBackdropLabel').innerText = 'Modifier la catégorie';
            var id = edit_id;
            ...
            document.getElementById('staticBackdropLabel').innerText = 'Nouvelle catégorie';
