...
$edit_societe_id = isset($_GET['edit_id']) ? $_GET['edit_id'] : null;
    ...
    if (isset($_POST['submit'])) {
        ...
        if (empty($id_societe_importateur)) {
            ...
            $sql = "INSERT INTO `societe_importateur`(`nom_societe_importateur`, `adresse_societe_importateur`, `contact_societe_importateur`, `email_societe_importateur`) VALUES ('$nom','$adresse','$contact','$email')";
            ...
            $sql = "UPDATE `societe_importateur` SET `nom_societe_importateur`='$nom', `adresse_societe_importateur`='$adresse', `contact_societe_importateur`='$contact', `email_societe_importateur`='$email' WHERE `id_societe_importateur`='$id_societe_importateur'";
            $result = mysqli_query($conn, $sql);
        ...
        <table class="table table-hover text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $row['email_societe_importateur'] ?></td>
                    <td>
